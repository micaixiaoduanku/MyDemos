 ...
 */
public class TopContentView extends RelativeLayout implements View.OnTouchListener{

    private final String TAG = "TopContentView";
    ...
    private void init(Context context){
        ...
        inflater.inflate(R.layout.layout_top_content, this);
    }

    @Override
    public boolean onTouchEvent(MotionEvent event) {
        super.onTouchEvent(event);
        Log.i(TAG,"TopContentView onTouchEvent 收到");
        return true;
    }
